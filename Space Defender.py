...
# Create and set the screen size
...
# Score variable
score = 0
my_font = pygame.font.Font('QuirkyRobot.ttf', 32)
text_x = 10
text_y = 10


# End of Game message (Game Over)
end_font = pygame.font.Font('QuirkyRobot.ttf', 60)

def final_text():
    my_final_font = end_font.render("GAME OVER", True, (255, 255, 255))
    screen.blit(my_final_font, (350, 200))
...
while is_running:
    ...
    # call for player icon and pass in coordinates (Modify location)
    ...
    # call for enemy icon and pass in coordinates (Modify location)
